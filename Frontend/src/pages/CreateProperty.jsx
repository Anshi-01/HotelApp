...
const CreateProperty = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const formatedData = {
      ...
      amenities: data.amenities.split(",").map((item) => item.trim()), // Convert string to array
      images: data.images.split(" ").map((img) => img.trim()), // Convert space-separated string to array
    };
    

    try {
      let res = await createPropertyService(formatedData);
