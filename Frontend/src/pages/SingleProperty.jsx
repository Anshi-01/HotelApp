...
import { addReview } from "../api/reviewServices";
...
const SingleProperty = () => {
  ...
  const getreviews = async (id) => {
    ...
    if (res && res.length > 0) {
      ...
      setavgRating(0); // Set default rating if no reviews
    }
  };
          ...
          <div className=" mx-auto py-4  relative">
            ...
            <div className="w-full py-4 flex flex-col items-start gap-4">
              <form onSubmit={handleSubmit(onSubmit)} className="w-full">
                ...
                {/* Submit Button */}
                <button
                  className="bg-[#b17f44] text-white font-bold py-2 px-4 rounded-lg mt-4"
                  type="submit"
                >
                  Add your review
                </button>
